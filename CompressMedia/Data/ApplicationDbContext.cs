    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Permission>().HasData(
                ...
                new Permission { PermissionId = 18, PermissionName = "ViewTenant" },
                new Permission { PermissionId = 19, PermissionName = "ViewReport" },
                new Permission { PermissionId = 20, PermissionName = "Report" },
                new Permission { PermissionId = 21, PermissionName = "ViewContainer" }
            );
            ...
            modelBuilder.Entity<UserPermission>().HasData(
                ...
                new UserPermission { UserId = "7a4fad07-84c6-4a6c-abc6-80b9948602a6", PermissionId = 18 },
                new UserPermission { UserId = "7a4fad07-84c6-4a6c-abc6-80b9948602a6", PermissionId = 19 },
                new UserPermission { UserId = "7a4fad07-84c6-4a6c-abc6-80b9948602a6", PermissionId = 20 },
                new UserPermission { UserId = "7a4fad07-84c6-4a6c-abc6-80b9948602a6", PermissionId = 21 }
            );
