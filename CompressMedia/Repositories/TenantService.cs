        ...
        public async Task<string> CreateTenantAsync(TenantDto tenantDto)
        {
            ...
            if (!tenant.Roles.Any(r => r.RoleName == "Admin"))
            {
                ...
                List<RolePermission> rolePermissions = new List<RolePermission>
                {
                    ...
                    new RolePermission{RoleId=adminRole.RoleId, PermissionId=19},
                    new RolePermission{RoleId=adminRole.RoleId, PermissionId=20},
                    new RolePermission{RoleId=adminRole.RoleId, PermissionId=21}
                };
                ...
                List<UserPermission> userPermissions = new List<UserPermission>
                {
                    ...
                    new UserPermission { UserId = user.UserId, PermissionId = 16 },
                    new UserPermission { UserId = user.UserId, PermissionId = 17 },
                    new UserPermission { UserId = user.UserId, PermissionId = 19 },
                    new UserPermission { UserId = user.UserId, PermissionId = 20 },
                    new UserPermission { UserId = user.UserId, PermissionId = 21 },
                };
